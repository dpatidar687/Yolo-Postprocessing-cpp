...
static const std::vector<float> IMAGENET_MEAN_BGR = {0.406, 0.456, 0.485}; // these are in BGR

static const std::vector<float> IMAGENET_STD_BGR = {0.225, 0.224, 0.229}; // these are in BGR

static const std::vector<float> IMAGENET_MEAN_RGB = {0.485, 0.456, 0.406};

static const std::vector<float> IMAGENET_STD_RGB = {0.229, 0.224, 0.225};
